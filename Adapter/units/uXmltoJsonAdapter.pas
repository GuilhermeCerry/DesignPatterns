unit uXmltoJsonAdapter;

interface

uses Xml.XMLDoc, System.JSON, System.Classes, System.SysUtils,
  System.StrUtils, FMX.Forms, XMLIntf, System.Generics.Collections;

type
  TXmlToJsonAdapter = class(
    TInterfacedObject
  )
  private
...
function TXmlToJsonAdapter.attributeToStringList(atributos: String): TStringList;
var
...
function TXmlToJsonAdapter.fileToFile(filePath: String; filePathResult : String = ''): Boolean;
var
  arquivo : TStringList;
  strContent : String;
...
function TXmlToJsonAdapter.fileToReturnType(filePath: String): TJSONObject;
var
  arquivo : TStringList;
  strContent : String;
  xmlContent : TXMLDocument;
...
function TXmlToJsonAdapter.fileToString(filePath: String): String;
var
  arquivo : TStringList;
  strContent : String;
  xmlContent : TXMLDocument;
...
function TXmlToJsonAdapter.normalizeOrigin(content: String): TXMLDocument;
var
  xmlReturn : TXMLDocument;

begin
  try
    xmlReturn := TXMLDocument.Create(nil);
    xmlReturn.LoadFromXML(content);
    //Esta limpando o FXMLData
    Result := xmlReturn;
  except
...
function TXmlToJsonAdapter.normalizeOrigin(content: TXMLDocument): TStringList;
var
  nodo : IXMLNode;
...
function TXmlToJsonAdapter.nodeToStringList(nodo: IXMLNode; nivel : Integer): TStringList;
var
  nome : String;
  atributos : string;
  abertura : string;
...
function TXmlToJsonAdapter.nodeToStringJson(nodo: IXMLNode; atr : String): TStringList;
var
  nome : String;
...
function TXmlToJsonAdapter.nodeToStringList(nodo: TJSONArray; nivel: Integer): TStringList;
var
  listReturn : TStringList;
  I: Integer;
  item : TJSONValue;
...
function TXmlToJsonAdapter.normalizeOrigin(content: TStringList): String;
var
  I: Integer;
  strReturn : String;
...
function TXmlToJsonAdapter.normalizeReturn(content: String): TJSONObject;
var
  jsonReturn : TJSONObject;
...
function TXmlToJsonAdapter.normalizeReturn(content: TJSONObject): TStringList;
var
  nodo : TJSONArray;
...
function TXmlToJsonAdapter.normalizeReturn(content: TStringList): String;
var
  I: Integer;
  strReturn : String;
...
function TXmlToJsonAdapter.originTypeToFile(content: TXMLDocument; filePathResult : String): Boolean;
var
  arquivo : TStringList;
  jsonReturn : TJSONObject;
...
function TXmlToJsonAdapter.originTypeToReturnType(content: TXMLDocument): TJSONObject;
var
  nodo : IXMLNode;
  str : String;
  json : TJSONObject;
...
function TXmlToJsonAdapter.originTypeToString(content: TXMLDocument): String;
var
  jsonReturn : TJSONObject;
  arquivo : TStringList;
  strReturn : String;
...
function TXmlToJsonAdapter.getAtributosStr(nodos: IXMLNodeList): string;
var
  I: Integer;
  strReturn: string;
...
function TXmlToJsonAdapter.typeText(json: String): String;
begin
  if json = 'node' then
  begin
    Result := json;
...
function TXmlToJsonAdapter.stringToFile(strContent, filePathResult: String): Boolean;
var
  arquivo : TStringList;
  xmlContent : TXMLDocument;
  jsonReturn : TJSONObject;
...
function TXmlToJsonAdapter.stringToReturnType(strContent: String): TJSONObject;
var
  xmlContent : TXMLDocument;
  jsonReturn : TJSONObject;
...
function TXmlToJsonAdapter.stringToString(strContent: String): String;
var
  xmlContent : TXMLDocument;
  jsonReturn : TJSONObject;
  arquivo : TStringList;
...
function TXmlToJsonAdapter.tabular(nivel: integer): String;
var
  I : Integer;
